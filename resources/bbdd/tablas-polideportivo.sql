...
-> CREATE TABLE deporte (id INT AUTO_INCREMENT NOT NULL, nombre_deporte VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB
     -> CREATE TABLE pista (id INT AUTO_INCREMENT NOT NULL, id_deporte_id INT NOT NULL, id_instalacion_id INT NOT NULL, n_pista VARCHAR(255) NOT NULL, precio_hora DOUBLE PRECISION NOT NULL, estado INT NOT NULL, comentarios VARCHAR(255) DEFAULT NULL, INDEX IDX_5E8F946E8616D40A (id_deporte_id), INDEX IDX_5E8F946E7361D98C (id_instalacion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB
     -> CREATE TABLE instalacion (id INT AUTO_INCREMENT NOT NULL, nombre_insta VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB
     -> ALTER TABLE pista ADD CONSTRAINT FK_5E8F946E8616D40A FOREIGN KEY (id_deporte_id) REFERENCES deporte (id)
     -> ALTER TABLE pista ADD CONSTRAINT FK_5E8F946E7361D98C FOREIGN KEY (id_instalacion_id) REFERENCES instalacion (id)
