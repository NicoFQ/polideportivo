...
PRIMARY KEY (email, id_reserva, id_usuario, fecha, hora_inicio, hora_fin, id_pista),
KEY fkIdx_277 (email, id_usuario),
CONSTRAINT FK_277 FOREIGN KEY fkIdx_277 (email, id_usuario) REFERENCES usuario (email, id_usuario) ON DELETE CASCADE,
...
KEY fkIdx_380 (email, id_usuario),
CONSTRAINT FK_380 FOREIGN KEY fkIdx_380 (email, id_usuario) REFERENCES usuario (email, id_usuario) ON DELETE CASCADE
) ENGINE=INNODB;
...
(
 ...
 id_pista    varchar(20) NOT NULL ,
 email       varchar(45) NOT NULL ,
PRIMARY KEY (email, id_usuario, id_clase, fecha, hora_inicio, hora_fin, id_pista),
KEY fkIdx_338 (email, id_usuario),
CONSTRAINT FK_338 FOREIGN KEY fkIdx_338 (email, id_usuario) REFERENCES usuario (email, id_usuario) ON DELETE CASCADE,
