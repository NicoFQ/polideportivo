        ...
        <div class="row">
          <div class="col-md-12">
            <main class=jumbotron>
              <h2 class="text-center text-uppercase">Reserva de clases.</h2>
            <form action="confirma_datos.php"method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select name="clases" class="form-control">
                    ...
                    <option value="10">10:00 a 10:59</option>
                    <option value="11">11:00 a 11:59</option>
                    <option value="12">12:00 a 12:59</option>
                    <option value="13">13:00 a 13:59</option>
                    <option value="16">16:00 a 16:59</option>
                    <option value="17">17:00 a 17:59</option>
                    <option value="18">18:00 a 18:59</option>
              ...
              <div class="form-group row">
                <label for="clases" class="col-sm-2 col-form-label">Con profesor</label>
                <div class="col-sm-10">
                  <input type="radio" name="estado_reserva" value="profesor">
                </div>
              </div>
              <div class="form-group row">
                <label for="clases" class="col-sm-2 col-form-label">Libre</label>
                <div class="col-sm-10">
                  <input type="radio" name="estado_reserva" value="libre">
                </div>
              </div>
